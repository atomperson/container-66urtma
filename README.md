...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-66urtma.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-66urtma.containers.anotherwebservice.com/
...
```
git clone git@github.com:atomperson/container-66urtma.git
cd container-66urtma
```
...
```
docker attach container-66urtma
```
